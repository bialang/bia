...
{
	_destination->template replace_this<framework::native::big_int_member>();
}

void BIA_STATIC_CALLING_CONVETION instantiate_int_1(framework::member *_destination)
{
	_destination->template replace_this<framework::native::big_int_member>(1);
}
...
{
	_destination->template replace_this<framework::native::cstring_member<char16_t>>(_string, _size, _length);
}
...
{
	_destination->template replace_this<framework::native::cstring_member<char32_t>>(_string, _size, _length);
}
