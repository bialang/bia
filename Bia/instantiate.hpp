...
BIA_EXPORT void BIA_STATIC_CALLING_CONVETION instantiate_big_int(framework::member * _destination, detail::big_int * _value);
...
/*BIA_EXPORT void BIA_STATIC_CALLING_CONVETION instantiate_string(framework::member *_destination, const char *_string);
BIA_EXPORT void BIA_STATIC_CALLING_CONVETION instantiate_string16(framework::member *_destination, const char16_t *_string);
