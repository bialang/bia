...
void BIA_MEMBER_CALLING_CONVENTION int_member::operator_call_big_int(member * _destination, operator_t _operator, const detail::big_int * _right)
{
	BIA_NOT_IMPLEMENTED;
}
...
int32_t int_member::int32_data(bool & _success) const
{
	_success = true;
...
int64_t int_member::int64_data(bool & _success) const
{
	_success = true;
...
double int_member::double_data(bool & _success) const
{
	_success = true;
