...
/**
 * @brief A simple implementation of @ref allocator, @ref member_allocator @ref big_int_allocator and @ref executable_allocator.
 *
...
*/
class simple_allocator : public allocator, public member_allocator, public big_int_allocator, public executable_allocator
{
public:
	...
	BIA_EXPORT virtual void deallocate_executable(universal_allocation _allocation) override;
	BIA_EXPORT virtual void protect_executable(universal_allocation _allocation, int _protection) override;
	...
	BIA_EXPORT virtual universal_allocation allocate_executable(size_type _size) override;
