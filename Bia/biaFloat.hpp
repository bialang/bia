...
class BiaFloat final : public BiaNativeVariable
{
public:
	inline explicit BiaFloat(float p_rValue) : m_rValue(p_rValue) {}
	inline explicit BiaFloat(double p_rValue) : m_rValue(static_cast<float>(p_rValue)) {}
	template<typename _DUMMY>
	inline explicit BiaFloat(_DUMMY)
	{
