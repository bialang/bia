...
{
	//Create left
	framework::native::BiaInt left(p_nLeft);
...
{
	//Create left
	framework::native::BiaInt left(p_llLeft);
...
{
	//Create left
	framework::native::BiaFloat left(p_rLeft);
...
{
	//Create left
	framework::native::BiaDouble left(p_rLeft);
