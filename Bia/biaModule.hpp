...
public:
	...
	*/
	...
	inline typename std::enable_if<std::is_base_of<framework::BiaMember, _Ty>::value>::type RegisterMember(const char * p_szName, _ARGS &&... p_args)
	{
		auto allocation = m_pAllocator->ConstructBlocks<_Ty>(1, BiaAllocator::MEMORY_TYPE::NORMAL, std::forward<_ARGS>(p_args)...);
