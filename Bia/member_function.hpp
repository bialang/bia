...
{
	_destination->replace_this<member_function<Optional_count, function_signature_t>>(_data.get().first);
}
...
{
	_destination->replace_this<member_function<Optional_count, function_signature_t>>(_data);
}
...
template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline member_function<Optional_count, Return(Class::*)(Arguments...) const>::member_function(function_signature_t _function) noexcept : _data(_function, object::instance_holder<Class>(machine::memory::allocation<Class>(), false))
{
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline member_function<Optional_count, Return(Class::*)(Arguments...) const>::member_function(const data_type & _data) noexcept : _data(_data)
{
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void BIA_MEMBER_CALLING_CONVENTION member_function<Optional_count, Return(Class::*)(Arguments...) const>::print() const
{
	puts(typeid(Return(Class::*)(Arguments...)).name());
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void BIA_MEMBER_CALLING_CONVENTION member_function<Optional_count, Return(Class::*)(Arguments...) const>::copy(member * _destination)
{
	_destination->replace_this<member_function<Optional_count, function_signature_t>>(_data.get().first);
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void BIA_MEMBER_CALLING_CONVENTION member_function<Optional_count, Return(Class::*)(Arguments...) const>::refer(member * _destination)
{
	_destination->replace_this<member_function<Optional_count, function_signature_t>>(_data);
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void BIA_MEMBER_CALLING_CONVENTION member_function<Optional_count, Return(Class::*)(Arguments...) const>::clone(member * _destination)
{
	refer(_destination);
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void BIA_MEMBER_CALLING_CONVENTION member_function<Optional_count, Return(Class::*)(Arguments...) const>::execute(machine::stack * _stack, member * _destination)
{
	force::disguised_caller<Optional_count>(cast_instance(), _data.get().first, _destination, nullptr, 0, nullptr);
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void BIA_VARG_MEMBER_CALLING_CONVENTION member_function<Optional_count, Return(Class::*)(Arguments...) const>::execute_count(machine::stack * _stack, member * _destination, void * _reserved, parameter_count_t _count)
{
	force::disguised_caller<Optional_count>(cast_instance(), _data.get().first, _destination, nullptr, _count, _stack);
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void BIA_VARG_MEMBER_CALLING_CONVENTION member_function<Optional_count, Return(Class::*)(Arguments...) const>::execute_format(machine::stack * _stack, member * _destination, const char * _format, parameter_count_t _count)
{
	force::disguised_caller<Optional_count>(cast_instance(), _data.get().first, _destination, _format, _count, _stack);
}

template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline void member_function<Optional_count, Return(Class::*)(Arguments...) const>::set_instance(const void * _instance, const std::type_info & _type)
{
	if (_type != typeid(Class)) {
		throw exception::type_error(BIA_EM_INVALID_INSTANCE_TYPE);
	}
...
template<size_t Optional_count, typename Class, typename Return, typename ...Arguments>
inline Class * member_function<Optional_count, Return(Class::*)(Arguments...) const>::cast_instance()
{
	auto _instance = _data.get().second.get();
