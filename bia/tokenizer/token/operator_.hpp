...
enum class operator_ : std::uint16_t
{
	...
	nullable_member_access      = make<13, 1, operator_type::infix>(),
	function_call_open          = make<13, 2, operator_type::prefix>(),
	nullable_function_call_open = make<13, 3, operator_type::prefix>(),
	function_call_close         = make<13, 4, operator_type::postfix>(),
};
