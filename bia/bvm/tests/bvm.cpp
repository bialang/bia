...
TEST_CASE("simple run", "[bvm]")
{
	...
	iw.write_instruction<false, bytecode::oc_push>(11);
	iw.write_instruction<false, bytecode::oc_push>(3);
	iw.write_instruction<false, bytecode::oc_invoke>(bytecode::local_member{ 0 }, 2);
