...
inline typename std::enable_if<bia::util::type_traits::equals_any<OP_CODE, Op_code, OC_JUMP, OC_JUMP_TRUE, OC_JUMP_FALSE>::value && bia::util::type_traits::equals_any_type<T, std::int8_t, std::int32_t>::value, void>::type
