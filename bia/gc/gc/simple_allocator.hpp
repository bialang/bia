...
/*
 A simple implememntation of the @ref memory_allocator that uses the given allocator and free functions without any additional synchronozation/caching.
*/
