...
inline unsigned int Hash32(const char * p_pcBuffer, unsigned int p_unLength)
{
...
inline unsigned long long Hash64(const char * p_pcBuffer, unsigned long long p_ullLength)
{
